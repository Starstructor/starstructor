...
namespace Starstructor.GUI
{
  public partial class MainWindow : Form
  {
    ...
    private void ChooseAssetsDirectory()
    {
      FolderBrowseStarbound.SelectedPath = Editor.Settings.AssetDirPath;
      DialogResult result = FolderBrowseStarbound.ShowDialog();
      if (result == DialogResult.OK)
      {
        Editor.Settings.AssetDirPath = FolderBrowseStarbound.SelectedPath;
      }
    }
