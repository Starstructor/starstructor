...
namespace DungeonEditor
{
    public class Editor
    {
        ...
        private Version m_version = System.Reflection.Assembly.GetExecutingAssembly().GetName().Version;
        ...
        public StarboundAsset LoadAsset(string name, string rawType)
        {
            ...
            if (path != null)
            {
                if (ext == ".material")
                {
                    ...
                    {
                        imagePath += tempAsset.PlatformImage;
                        originX = 24;
                    }
                    else
                    {
                        imagePath += tempAsset.Frames;
                        originX = 4;
                        originY = 12;
                    }
